          ...
          {['DASHBOARD'].map((text, index) => (
            <ListItem key={text} disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                ...
                <ListItemText primary={text} sx={{ opacity: open ? 1 : 0, color: grey[600], fontFamily: 'fantasy' }} />
              </ListItemButton>
            </ListItem>
          ))}
        </List>
          ...
          {['VENDORS', 'USERS'].map((text, index) => (
            <ListItem key={text} disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                ...
                <ListItemText primary={text} sx={{ opacity: open ? 1 : 0, color: grey[600] }} />
              </ListItemButton>
            </ListItem>
          ))}
        </List>
          ...
          {['AUTHENTICATION','ICONS','OTHER PAGES'].map((text, index) => {
            ...
            <ListItem key={text} disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                ...
                <ListItemText primary={text} sx={{ opacity: open ? 1 : 0, color: grey[600], fontFamily: 'monospace'  }} />
              </ListItemButton>
            </ListItem>
            )})}
        </List>
